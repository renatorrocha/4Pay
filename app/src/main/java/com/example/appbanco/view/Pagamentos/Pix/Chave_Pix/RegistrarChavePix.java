...
//                criarChavePix(tipoChave);
    ...
    private void getAllUsuarios(ChavePix chavePix) {
        ...
        allUsersRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                getAllChavesPix(usersList, chavePix);
            }
    ...
    private void getAllChavesPix(List<String> usersList, ChavePix chavePix) {
